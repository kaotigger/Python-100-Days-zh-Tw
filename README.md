...
> 作者：駱昊
>
> 說明：最近有很多想學習Python的小伙伴申請單獨加我微信和QQ，因為我自己平時也很忙，沒辦法一一解答大家的問題，我創建了**Python100天學習交流6群** （之前的兩個2000人群1群和2群、三個1000人群3群、4群、5群已經全部滿員），群號為**837590310**，二維碼在下方。我的同事和朋友也在這個群裡，他們很多都是優秀的Python開發者，有豐富的商業項目經驗，我們在時間充足的時候會及時解答大家的問題，從Python語言入門到Web應用開發，從數據分析到機器學習，每個領域都有技術大咖為大家解惑答疑。以後我們爭取每週做一次視頻直播，以專題的形式分享Python開發的點點滴滴，同時還會不定期的舉辦線上和線下的技術交流和分享活動，小伙伴們可以加群進行交流。創作不易，感謝各位小伙伴的打賞支持，也感謝**千鋒教育Python教學部**對QQ群的支持。
